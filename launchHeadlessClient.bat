...
:: Window Title
TITLE Launch Arma3 Headless Client Instance

:: General Params
:: Adjust below Params or use Input
set scriptVersion=0.0.1
set gamePort=2302
set instanceName=Arma3 Headless Client
...
set "startupParams=-filePatching -hugePages -noSound -cpuCount=1 -client -connect=localhost"
